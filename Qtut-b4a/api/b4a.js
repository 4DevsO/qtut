 ...
 */
module.exports.productCreate = (name, price, description, pictures, tags, creatorObjectId) => {
    return new Promise((resolve, reject) => {
 ...
 * @param {string} creatorObjectId
 */
module.exports.saleCreate = (fixed, products, mainProductObjectId, card, closeTime, location, locationDescription, creatorObjectId) => {
    return new Promise((resolve, reject) => {
